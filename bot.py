...
🔰 ᴏᴡɴᴇʀ ᴄᴀɴ ʙʀᴏᴀᴅᴄᴀsᴛ ᴍᴇssᴀɢᴇ ᴛᴏ ᴀʟʟ ᴜsᴇʀs
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [InlineKeyboardButton("👨‍💻Developer👨‍💻", url="https://t.me/PROFE07XH")],
                [
                    InlineKeyboardButton(
                        "🏘 Update Channel 🏘", url="https://t.me/Max_Leech_Zone_Update"
                    ),
                    InlineKeyboardButton(
    ...
    try:
        with userBot:
            userBot.send_message(
                ...
                text="Bot booted with Premium Account,\n\n  Thanks for using <a href='https://t.me/Max_Leech_Zone_Update'>Update Channel</a>",
